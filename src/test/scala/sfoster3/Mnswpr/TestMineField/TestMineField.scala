...
class TestMineField extends FlatSpec {
  implicit def coordinateFromInts(tu: (Int, Int)): Coordinate = Coordinate(tu._1, tu._2)

  "A MineField" should "be creatable from a set" in {
    val mines = Set((1, 2), (4, 6), (9, 0))
    MineField(10, 10, mines)
  }

  "A MineField" should "allow checking for mines" in {
  ...
  "A MineField" should "allow checking for bounds" in {
